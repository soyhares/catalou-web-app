...
export function WhatsAppFloatingButton() {
  ...
  if (isCheckout || !whatsappNumber) return null;

  const catalogDomain = (import.meta.env.VITE_CATALOG_DOMAIN as string | undefined) ?? 'catalou.com';
  const message = encodeURIComponent(
    `Hola, vi tu catálogo en https://${slug}.${catalogDomain} y me gustaría consultar sobre...`,
  );
